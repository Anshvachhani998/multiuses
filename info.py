...
class Config:
    ...
    MONGODB_URI = os.getenv("MONGODB_URI", "mongodb+srv://Ansh089:Ansh089@cluster0.y8tpouc.mongodb.net/?retryWrites=true&w=majority")
    DATABASE_NAME = os.getenv("DATABASE_NAME", "MUlTI")
    
    # Channel Configuration
    LOG_CHANNEL_ID = int(os.getenv("LOG_CHANNEL_ID", "-1002858808929")) if os.getenv("LOG_CHANNEL_ID") else None
    MEDIA_CHANNEL_ID = int(os.getenv("MEDIA_CHANNEL_ID", "-1002858808929")) if os.getenv("MEDIA_CHANNEL_ID") else None
